...
export const useResumeStore = defineStore('resume', () => {
  ...
  const projects = ref([

    {
      ...
      image: '/src/assets/screenshots/saas-platform.png',
    ...
    },
    {
      ...
      technologies: ['PHP', 'Laravel', 'JavaScript', 'Composer', 'Open Source'],
    ...
    },
    {
      ...
      technologies: ['PHP', 'Laravel', 'PostgreSQL', 'JavaScript', 'Nuxt.js', 'REST API', 'Payment Gateway', 'CMS', 'Multi-language'],
